...
FluidPatcher should work on any operating system on which FluidSynth and Python can be installed. The *patcher* module controls FluidSynth and handles patches and banks, and you create implementations ([see example below](#example)) so your bank files can be portable and useful in different contexts (e.g. performing, editing, or recording). Several implementations are included:
