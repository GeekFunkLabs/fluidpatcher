...
class Router:
	...
	def addrule(self, type, chan=None, num=None, val=None, **apars):
		if apars:
			self.customrules.insert(0, CustomRule(type, chan, num, val, tags, **apars))
		elif type[0] != type[1]:
			self.customrules.insert(0, TransRule(type, chan, num, val, tags))
